...
public class CalendarRepository {
    ...
    public List<CalendarEvent> getObligaciones() throws Exception {
        ...
        String sql = "SELECT titulo, fecha, color, area \n"
                ...
                + "    -- cronogramaPDT \n"
                + "    SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#041562' AS color, 8 AS area \n"
                + "    FROM cronogramaPDT \n"
                + "    CROSS APPLY ( \n"
                + "        VALUES \n"
                + "            ('DJ PDT RUC 0', fecha0), \n"
                ...
                + "    -- cronogramaSire \n"
                + "    SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#11468F' AS color, 8 AS area \n"
                + "    FROM cronogramaSire \n"
                + "    CROSS APPLY ( \n"
                + "        VALUES \n"
                ...
                + "            WHEN '12' THEN 'DIC' \n"
                + "        END AS titulo, \n"
                + "        fecha, '#1230AE' AS color, 8 AS area \n"
                ...
                + "            WHEN '12' THEN 'DIC' \n"
                + "		END AS titulo, \n"
                + "		fecha, '#e355e1' AS color, 4 AS area \n"
                + "    FROM cronogramaAfp \n"
                + " \n"
                + "     UNION ALL \n"
                + " \n"
                ...
                + "            WHEN '11' THEN 'NOV' \n"
                + "		END AS titulo, \n"
                + "		fecha, '#725CAD' AS color, 4 AS area \n"
                + "    FROM cronogramaCts \n"
                + "\n"
                + "	UNION ALL \n"
                + " \n"
                ...
                + "            WHEN '12' THEN 'DIC' \n"
                + "		END AS titulo, \n"
                + "		fecha, '#7E8EF1' AS color, 4 AS area \n"
                ...
                + "            WHEN '12' THEN 'DIC' \n"
                + "		END AS titulo, \n"
                + "		fecha, '#800080' AS color, 8 AS area \n"
                + "	FROM cronogramaDetracciones \n"
                + " \n"
                + "	UNION ALL \n"
                + " \n"
                + "	SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#33b2ff' AS color, 8 AS area \n"
                ...
                + " \n"
                + "	SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#F49BAB' AS color, 8 AS area \n"
                ...
                + " \n"
                + "    SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#483AA0' AS color, 8 AS area \n"
                + "    FROM cronogramaDaot \n"
                + "    CROSS APPLY ( \n"
                + "        VALUES \n"
                ...
                + " \n"
                + "    SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#129990' AS color, 8 AS area \n"
                ...
                + " \n"
                + "    SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#4A102A' AS color, 8 AS area \n"
                ...
                + " \n"
                + "    SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#C95792' AS color, 8 AS area \n"
                + "    FROM cronogramaPDT \n"
                + "    CROSS APPLY ( \n"
                + "        VALUES \n"
                + "            ('DJ PDT 648 0', fecha0), \n"
                ...
                + " \n"
                + "    SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#88304E' AS color, 8 AS area \n"
                + "    FROM cronogramaPDT \n"
                + "    CROSS APPLY ( \n"
                + "        VALUES \n"
                + "            ('DJ B. FINAL 0', fecha0), \n"
                ...
                + " \n"
                + "    SELECT \n"
                + "        titulos.titulo, titulos.fecha, '#5F8B4C' AS color, 8 AS area \n"
                + "    FROM cronogramaPDT \n"
                + "    CROSS APPLY ( \n"
                + "        VALUES \n"
                ...
                + "            WHEN '12' THEN 'DIC' \n"
                + "		END AS titulo, \n"
                + "		fecha, '#640D5F' AS color, 8 AS area \n"
                ...
                + "            WHEN '10' THEN 'OCT' \n"
                + "		END AS titulo, \n"
                + "		fecha, '#493D9E' AS color, 8 AS area \n"
